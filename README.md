...
3. **Archive and upload from the Mac** — In Xcode: Product → Archive. When the Organizer appears, select the archive → Distribute App → App Store Connect → Upload. After processing, the build appears under TestFlight for that app.
